                                ...
                                <td class="py-2 px-4 border-b">
                                    <form method="POST" action="{{ route('chef.pedido.actualizar-agrupado') }}">
                                        ...
                                        <select name="estado" class="border border-gray-300 rounded px-2 py-1 text-sm">
                                            ...
                                            <option value="listo para entrega" {{ $pedido->estado == 'listo para entrega' ? 'selected' : '' }}>Listo para entrega</option>
                                            <option value="listo" {{ $pedido->estado == 'listo' ? 'selected' : '' }}>Listo</option>
                                            <option value="entregado" {{ $pedido->estado == 'entregado' ? 'selected' : '' }}>Entregado</option>
                                        </select>
                                        <button type="submit" class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm ml-2">
                                            Actualizar
                                        </button>
                                    </form>
                                </td>
